...
def migrate_python_prompts():
    ...
    for name, module_path, variable_name in prompts_to_migrate:
        ...
        try:
            ...
            langfuse.create_prompt(
                name=name, prompt=prompt_text, type="text", labels=["production"]
            )

...
from src.governed_financial_advisor.agents.financial_advisor.prompt import FINANCIAL_COORDINATOR_FALLBACK_PROMPT
from src.governed_financial_advisor.agents.data_analyst.agent import PLANNER_PROMPT_TEXT, EXECUTOR_PROMPT_TEXT
from src.governed_financial_advisor.agents.execution_analyst.agent import EXECUTION_ANALYST_FALLBACK_PROMPT
from src.governed_financial_advisor.agents.explainer.agent import EXPLAINER_FALLBACK_PROMPT
from src.governed_financial_advisor.agents.governed_trader.agent import EXECUTOR_FALLBACK_PROMPT as GOVERNED_TRADER_FALLBACK_PROMPT

...
# ─── Production Environment Configuration (us-central1) ───────────────────────

environment = "prod"
region      = "us-central1"
zone        = "us-central1-a"

# US_FED compliance profile: NIST SP 800-53 FedRAMP Moderate
cage_deployment_region = "US_FED"

# ─── High Availability ────────────────────────────────────────────────────────
# Full HA: multi-region Redis, Cloud SQL failover, minimum 2 instances

enable_high_availability = true
enable_nist_compliance   = true

# ─── Database Sizing ──────────────────────────────────────────────────────────
# Production-grade capacity and redundancy
...
# ─── Cloud Run Scaling ────────────────────────────────────────────────────────
# Always-on instances for production availability

...
| **Evidence Stream Blocking Preconditions** | `src/gateway/governance/evidence/stream.py` | Hard startup precondition guard (`validate_evidence_stream_preconditions()`) halting in production if evidence durability blocking is bypassed. |

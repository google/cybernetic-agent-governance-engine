...
class AssurancePosture(BaseModel):
    ...
    disclaimer: str = (
        "This artifact represents a deterministic architectural reference generated by "
        "the Cybernetic Agent Governance Engine (CAGE). It demonstrates control mechanism "
        "linkage and evidence gathering paths. It does NOT constitute a formal statutory "
        "attestation, FedRAMP ATO, CE Conformity Mark, BSI ISO/IEC 42001 certification, "
        "or MAS regulatory approval. Formal certification requires independent assessment "
        "by an accredited third-party body within the deploying organization's operational context."
    )

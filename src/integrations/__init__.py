...
is a complete vendor integration boundary:
  ...
  integrations/
  ├── nexart/       — NexArt CER attestation + LangGraph adapter
  └── trustlayers/  — TrustLayers normative compliance provider
...
Adding a new vendor
-------------------
1. Create ``src/integrations/{vendor}/``
...
5. Add tests in ``src/integrations/{vendor}/tests/``
"""

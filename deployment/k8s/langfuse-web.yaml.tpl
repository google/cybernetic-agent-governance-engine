...
#
# Template: deployment/k8s/langfuse-web.yaml.tpl
#
# Region-aware template for the Langfuse web deployment.
# Converts the static langfuse-web.yaml to a region-parameterised template
  ...
  template:
    ...
    spec:
      ...
      securityContext:
        ...
        seccompProfile:
          type: RuntimeDefault
      # Stable Tier: Avoid Spot nodes to prevent downtime at minReplicas=1
      affinity:
        nodeAffinity:
        ...
        - name: langfuse-web
          ...
          env:
            ...
            - name: CLICKHOUSE_CLUSTER_ENABLED
              value: "false"
            # Injected so the Langfuse web pod can emit jurisdiction-tagged telemetry.

...
def main():
    parser = argparse.ArgumentParser(
        description="Teardown Cybernetic Governance Engine Resources"
    )
    ...
    parser.add_argument(
        "--service-name",
        default="financial-advisor-ui",
        help="Cloud Run UI Service Name",
    )
    ...
    print(
        "This will delete the GKE cluster, Cloud Run service, and Secret Manager secrets."
    )
    ...
    for s in secrets:
        run_command(
            ["gcloud", "secrets", "delete", s, "--project", args.project_id, "--quiet"],
            check=False,
        )

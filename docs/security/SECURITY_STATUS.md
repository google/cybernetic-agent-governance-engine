# Security & Compliance Status — CAGE v3.0.1
...
The following weaknesses are documented in [`compliance/us_fed/POAM_US_FED.md`](../compliance/us_fed/POAM_US_FED.md) (v2.0, 2026-06-08 — authoritative for US_FED). Items marked **Closed** were resolved; see POAM_US_FED.md for full closure evidence. For universal ISO 42001 AIMS weaknesses (all regions), see [`compliance/universal/POAM_ISO42001.md`](../compliance/universal/POAM_ISO42001.md). For the cross-region traceability matrix, see [`compliance/cross-region/POAM_INDEX.md`](../compliance/cross-region/POAM_INDEX.md):
...
| Document                            | Location                                                                                                                                                           |
| ----------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| POA&M Index (all regions)           | [`compliance/cross-region/POAM_INDEX.md`](../compliance/cross-region/POAM_INDEX.md)                                                                                                                              |
| POA&M — ISO 42001 universal (ALL)   | [`compliance/universal/POAM_ISO42001.md`](../compliance/universal/POAM_ISO42001.md)                                                                                                                        |
| POA&M — US_FED (NIST SP 800-53)     | [`compliance/us_fed/POAM_US_FED.md`](../compliance/us_fed/POAM_US_FED.md)                                                                                                                            |
| POA&M — EU_ECB (EU AI Act / DORA)   | [`compliance/eu_ecb/POAM_EU_ECB.md`](../compliance/eu_ecb/POAM_EU_ECB.md)                                                                                                                            |
| POA&M — APAC_MAS (MAS FEAT)         | [`compliance/apac_mas/POAM_APAC_MAS.md`](../compliance/apac_mas/POAM_APAC_MAS.md)                                                                                                                        |
| NIST RMF Current-State Inventory    | [`docs/compliance/us_fed/NIST_RMF_CHUNK1_CURRENT_STATE.md`](../compliance/us_fed/NIST_RMF_CHUNK1_CURRENT_STATE.md)                                                                                        |
| NIST RMF Gap Analysis (Steps 2–5)   | [`docs/compliance/us_fed/NIST_RMF_CHUNK2_PREPARE_CATEGORIZE.md`](../compliance/us_fed/NIST_RMF_CHUNK2_PREPARE_CATEGORIZE.md) — [`NIST_RMF_CHUNK5_MONITOR_ROADMAP.md`](../compliance/us_fed/NIST_RMF_CHUNK5_MONITOR_ROADMAP.md) |
| ISO 42001 Compliance Detail         | [`compliance/universal/ISO_42001_COMPLIANCE.md`](../compliance/universal/ISO_42001_COMPLIANCE.md)                                                                                                          |
| Governance Crosswalk                | [`compliance/cross-region/GOVERNANCE_CROSSWALK.md`](../compliance/cross-region/GOVERNANCE_CROSSWALK.md)                                                                                                          |

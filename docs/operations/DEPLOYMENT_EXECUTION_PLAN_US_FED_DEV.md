...
> **Cluster:** `cage-dev` · Project: `laah-cybernetics` · Zone: `us-central1-a`  
...
**Expected:** Active account listed; project returns `laah-cybernetics`.
...
**Expected:** Context points to `cage-dev` (e.g., `gke_laah-cybernetics_us-central1-a_cage-dev`). If not, run:
...
```bash
gsutil ls gs://laah-cybernetics-models/
```
...
gsutil ls -b gs://laah-cybernetics-langfuse-events 2>/dev/null \
...
terraform -chdir=infra/targets/gcp-gke import \
  ...
  "laah-cybernetics/us-central1-a/cage-dev"
```
...
terraform -chdir=infra/targets/gcp-gke import \
  ...
  "laah-cybernetics/us-central1-a/cage-dev/primary-pool"
```
...
terraform -chdir=infra/targets/gcp-gke import \
  ...
  "laah-cybernetics/us-central1-a/cage-dev/gpu-pool"
```
...
terraform -chdir=infra/targets/gcp-gke import \
  ...
  "laah-cybernetics-langfuse-events"
```

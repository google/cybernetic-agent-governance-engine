...
| 5    | Control Barrier Function    | [`cbf.py ControlBarrierFunction`](../../src/gateway/governance/cbf.py)                    | Discrete-time CBF; `h(x)=cash_balance−min_cash_balance`, γ=0.5, min=$1,000; Redis Lua atomic      | Every `execute_trade` call               |

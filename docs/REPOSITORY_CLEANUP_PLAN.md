...
- `cloudbuild.gateway.yaml` uses `_GCP_PROJECT_ID: "laah-cybernetics"` (hardcoded project ID — **a secret hygiene violation per Rule 9.1**)
...
|---|---|---|
| 1.1 | Remove hardcoded `_GCP_PROJECT_ID: "laah-cybernetics"` from `deployment/docker/cloudbuild.gateway.yaml` | Credential/project ID leak in public repo |

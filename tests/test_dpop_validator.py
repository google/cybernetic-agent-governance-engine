...
class TestDPoPValidator:
    ...
    def _create_dpop_jwt(self, private_key, public_key, htm: str, htu: str, iat: int, jti: str) -> str:
    ...
    @pytest.mark.asyncio
    async def test_missing_required_claims(self, validator, test_keypair, test_cert_pem):

...
SCHEMA_DIR = (
    pathlib.Path(__file__).parent.parent.parent.parent / "schemas" / "provider_02"
)
FIXTURE_DIR = (
    pathlib.Path(__file__).parent.parent.parent / "fixtures" / "provider_02_native"
)


def load_schema_with_refs(
    schema_name: str,

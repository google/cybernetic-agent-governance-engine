...
class UniversalClaimingTier:
    """Tier that claims all actions (for testing capability dispatch)."""

    def __init__(self, tier_name: str = "universal", phase: int = 1, order: int = 0):
...
def mock_governor() -> SymbolicGovernor:
    """Create a SymbolicGovernor with mock dependencies and a universal tier."""
    ...
    # Register a tier that claims all actions
    gov.register_domain_tier(UniversalClaimingTier())
    return gov
